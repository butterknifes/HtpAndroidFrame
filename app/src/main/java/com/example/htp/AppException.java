...
import com.example.htp.utils.DatetimeUtils;
import com.example.htp.utils.FileUtil;
...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    private boolean saveToSDCard(Throwable ex) throws Exception {
        ...
        File file = FileUtil.getSaveFile("OSChina", "OSCLog.log");
        ...
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(
                file, append)));
        // 导出发生异常的时间
        pw.println(DatetimeUtils.getDataTime("yyyy-MM-dd-HH-mm-ss"));
        // 导出手机信息
        dumpPhoneInfo(pw);
        pw.println();
        // 导出异常的调用栈信息
