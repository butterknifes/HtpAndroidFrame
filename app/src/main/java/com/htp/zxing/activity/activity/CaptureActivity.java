 ...
 */
package com.htp.zxing.activity.activity;
...
import com.example.htp.AppException;
import com.example.htp.UIHelper;
import com.example.htp.api.remote.HtpApi;
import com.example.htp.base.BaseActivity;
import com.example.htp.bean.BarCode;
import com.example.htp.bean.ResultBean;
import com.example.htp.bean.SingInResult;
...
import com.htp.zxing.activity.camera.CameraManager;
import com.htp.zxing.activity.decode.DecodeThread;
import com.htp.zxing.activity.utils.BeepManager;
import com.htp.zxing.activity.utils.CaptureActivityHandler;
import com.htp.zxing.activity.utils.InactivityTimer;
...
//		.putExtras(bundle));
    ...
    private void handleScanLogin(final String url) {
        HtpApi.scanQrCodeLogin(url, new AsyncHttpResponseHandler() {
    ...
    private void handleSignIn(BarCode barCode) {
        ...
        HtpApi.singnIn(barCode.getUrl(), handler);
    }
